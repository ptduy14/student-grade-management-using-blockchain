...
export default function CompleteSemesterModal({
  semesterId,
  isSemesterCompleted,
  ...
  setIsSemesterCompleted: React.Dispatch<SetStateAction<boolean>>;
}) {
  ...
  return (
    <>
      <Button
        ...
        onPress={onOpen}
        isDisabled={isSemesterCompleted}
      >
              ...
              <ModalBody>
                <p>
                  ...
                  <span className="font-bold">
                    khóa mọi chỉnh sửa và không thể thay đổi
                  </span>
                  . Vui lòng đảm bảo rằng tất cả học phần đã được hoàn tất.
                </p>

                {isHandling && (
                  <p className="font-bold">
                    Thao tác này đồng thời sẽ tính toán điểm tổng kết học kỳ của
                    sinh viên, do đó có thể mất một chút thời gian để hệ thống
                    xử lí...
                  </p>
                )}
              </ModalBody>
